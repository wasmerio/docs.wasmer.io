...
- Behavior: If your app requires a database, Wasmer will automatically detect it and attach a database to your app.
...
DB:        MySQL / PostgreSQL (auto‑detected) → env: DB_HOST, DB_PORT, DB_NAME, DB_USERNAME, DB_PASSWORD
```
