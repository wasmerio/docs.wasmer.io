...
<Callout type="warning">
  Wasmer Deploy is still in heavy development. Use in production apps with caution.
</Callout>
...
Wasmer Deploy uses [Wasmer Runtime](/runtime), which allows having sandboxed environments when running your applications.
