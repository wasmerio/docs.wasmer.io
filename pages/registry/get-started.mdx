...
Register a new account in the [Wasmer Registry](https://wasmer.io/sign-up).

Then, generate a new token in [your Access Tokens settings page](https://wasmer.io/settings/access-tokens).
