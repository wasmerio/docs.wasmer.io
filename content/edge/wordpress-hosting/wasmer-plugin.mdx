...
The Wasmer plugin is a required integration plugin for managed WordPress apps on Wasmer Edge. You should not deactivate it, delete it, or remove it from the filesystem if you want WordPress to integrate seamlessly with Wasmer. If the plugin is missing, the Wasmer dashboard shows a banner offering to reinstall it.
