...
- **Django** -- set `EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'` or use a sendmail backend package.

## Rate Limits

Email sending requires a paid plan. Sending quotas vary by plan. See the
