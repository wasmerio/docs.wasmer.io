...
Wasmer Edge allows running Wasmer containers in the Wasmer Edge Nodes. It's also self-hostable (soon!).

<Callout type="warning">
  Wasmer Edge is still in heavy development. Use in production apps with
  caution.
</Callout>
...
- Supports the following runners:
  - WASIX: _any_ programming language and framework
...
- _Deploy at the Edge using the Cloud version, or self-host it (soon!)_
- _100% open-source (soon!)_

# How it works

Wasmer Edge uses [Wasmer Runtime](/runtime), which allows it to have sandboxed environments while running your applications.
...
<Callout type="info" emoji="ℹ️">
  You can also read an article by KodeCloud comparing [WASI vs
  Docker](https://kodekloud.com/blog/webassembly-vs-docker/)
</Callout>
