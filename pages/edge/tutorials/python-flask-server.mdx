...
Deploying app wasmer-python-flask-server...

 ✅ App dynamite-bud/wasmer-python-flask-server was successfully deployed!

> App URL: https://wasmer-python-flask-server.wasmer.app
> Versioned URL: https://2mzhyi8cqzxr.id.wasmer.app
> Admin dashboard: https://wasmer.io/apps/wasmer-python-flask-server
