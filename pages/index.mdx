...
[Wasmer](https://wasmer.io/) is an ecosystem system based on WebAssembly that allows running applications anywhere: in the browser, embedded in your favorite programming language, or standalone in the server.
...
2. [Wasmer Registry](/registry): explore containers from other users and to publish and distribute your own ones.
{/* 3. [Wasmer Deploy](/deploy): run containers on Wasmer distributed Edge */}
