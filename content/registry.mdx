...
import { PublishIcon } from '@components/icons/ProductIcons'

# Introduction to Wasmer Registry
...
<Cards>
<Card icon={<PublishIcon width={20} height={20} />} title="Publish your first package" href="/registry/get-started" />
</Cards>
