...
- `deploy.yaml` - This file contains the configuration for the Wasmer Edge deployment.
...
spec:
  workload:
    source: <your-namespace>/wasmer-hello@0.1.0
```

<Callout type="info" emoji="ℹ️">
  You can also check if your configuration is valid by running `wasmer publish
  --dry-run`. To learn more about the `wasmer.toml` file, click [here](/todo/).
</Callout>
...
$ wasmer deploy
  ...
  [1/2] ⬆️   Uploading...
  [2/2] 📦  Publishing...
  Successfully published package `<your-namespace>/wasmer-hello@0.1.0`
