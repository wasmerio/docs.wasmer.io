...
The manifest (`wasmer.toml`) is required [to publish](publishing-your-package.md) to the [Wasmer registry](https://wasmer.io); it's where a package's dependencies, metadata, and commands are declared.
