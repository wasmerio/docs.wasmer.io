...
| Python, PHP, JS   | Do not compile. Run the prebuilt runtimes: `python/python`, `php/php-32`, `wasmer/edgejs`. Find more with `wasmer package search` |
...
These runtime packages can be launched with `wasmer run` or composed inside a
sandbox through the [JavaScript SDK](/runtime/javascript-sdk) and
