...
The manifest file called `wasmer.toml` is required [to publish](publishing-your-package.md) to the [Wasmer registry](https://wasmer.io/products/registry); This file contains the package's dependencies, metadata, and commands are declared.
