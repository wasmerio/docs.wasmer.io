import { Card, Steps, Callout, FileTree } from '@components/nextra-theme';
...
Don't change the `root` setting in the `Staticfile` for this tutorial.
...
```bash copy
sed -i -e 's/Wasmer Static Site/This is our new title!/g' public/index.html 
```
