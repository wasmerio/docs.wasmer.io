...
The native CLI and Python SDK use Wasmer's native compiler backends. The
[JavaScript SDK](/runtime/javascript-sdk) targets the host JavaScript engine:
Node.js and browsers compile and execute WebAssembly while Wasmer supplies the
package, sandbox, filesystem, process, and WASIX layers. See the
[Python SDK guide](/runtime/python-sdk) for native embedding from Python.
...
[^1]: [Singlepass support for multi-value is experimental and does not include integration with host functions returning multiple values.](https://github.com/wasmerio/wasmer/issues/5943)
...
|                | x86_64 | arm64 | riscv64gc | loongarch64 |
| -------------- | ------ | ----- | --------- | ----------- |
| Cranelift      | ✅     | ✅    | ✅        | ❌          |
| LLVM           | ✅     | ✅    | ✅        | ✅          |
| Singlepass     | ✅     | ✅    | ✅        | ❌          |
