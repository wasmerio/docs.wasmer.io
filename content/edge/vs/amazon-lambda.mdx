...
- Wasmer Edge is **more affordable** than Lambda
...
- Wasmer Edge can run UDP and other protocols (available on request as an early-access feature) while Amazon Lambda cannot.
