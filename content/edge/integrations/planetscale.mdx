...
[Sign in to PlanetScale](https://auth.planetscale.com/sign-in), and create an account if needed. Note that free accounts are no longer available. You can choose from Scaler, Team, or Enterprise [plans](https://planetscale.com/pricing) which include read-only regions.
