...
Then, let's try to deploy using the Axum starter template from GitHub:

```bash copy
wasmer deploy --template=https://github.com/wasmer-examples/axum-wasmer-starter
```
...
✔ What should be the name of the app? · my-axum-server
✔ Unpacked template
