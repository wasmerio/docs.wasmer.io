...
on _Settings_ and then select the _Environment Vars_ tab. That page hosts the
environment variables editor: click _Add variable_, fill in the name and the
value, and press _Save and Redeploy_ to apply the change to your app.
...
click on _Settings_ and then select the _Environment Vars_ tab. In that page,
you can immediately see the list of variables tied to your app. 
...
click on _Settings_ and then select the _Environment Vars_ tab. In that page,
you can immediately see the list of variables tied to your app. In order to
reveal a single value, click the eye-like button inside its value field; the
eye-like button at the top right of the card reveals all values at once.
...
click on _Settings_ and then select the _Environment Vars_ tab. In that page,
you can immediately see the list of variables tied to your app. In order to
update one, click the pencil-shaped _Edit_ button in the row's _Actions_
column, change the value, and confirm with _Save and Redeploy_. 
...
click on _Settings_ and then select the _Environment Vars_ tab. In that page,
you can immediately see the list of variables tied to your app. In order to
delete one, click the trash-shaped _Delete variable_ button in the row's
_Actions_ column, then confirm with _Save and Redeploy_. 
