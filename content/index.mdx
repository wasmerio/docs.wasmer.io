...
<Cards>
  <Card icon={<span>R</span>} title="Run your first package" href="/runtime/get-started" />
  <Card icon={<span>P</span>} title="Publish a package" href="/registry/get-started" />
  <Card icon={<span>E</span>} title="Deploy an app" href="/edge/get-started" />
</Cards>
