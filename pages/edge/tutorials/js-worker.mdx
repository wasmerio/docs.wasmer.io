...
# Starter guide for deploying a JS Worker

In this guide, you'll learn the process of deploying a javascript worker on Wasmer Edge.

## Deploying a JavaScript Worker
...
### Step 3.1: Initialize the JavaScript Worker Starter template
...
### Step 3.2: Testing your JavaScript Worker locally
...
"success":true,"package":"wasmer/js-worker-test"
```

### Step 3.3: Deploying your JavaScript Worker

Deploying is the easiest part. Just run the following command:

```shell copy
$ wasmer deploy
Deploying app wasmer/js-worker-test...

 ✅ App wasmer/js-worker-test was successfully deployed!

> App URL: https://wasmer-js-worker-test-worker.wasmer.app
> Versioned URL: https://rkkh7ikcgv1r.id.wasmer.app
> Admin dashboard: https://wasmer.io/apps/wasmer/wasmer-js-worker-test-worker
```
...
Congratulations! You have successfully deployed your javascript worker on Wasmer Edge.
