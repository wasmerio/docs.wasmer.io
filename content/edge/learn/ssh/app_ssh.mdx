...
<Callout type="info">
**Note**: This works a bit differently from SSH access to regular servers on
...
Only changes to files in volumes will persist after the SSH session ends.
Any changes to files outside of volumes will be lost!
</Callout>
...
first configure SSH access by following the [configuration documentation](./configuration).
