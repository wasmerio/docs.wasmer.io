...
# Creating a CDN on Wasmer Edge

In this tutorial, we will create a CDN on Wasmer Edge. We'll be using the [`static-web-server`]()
...
What should the package be called? It will be published under wasmer: <your-cdn-name> # This will be the package name of your CDN
What should be the name of the app? <NAME>.wasmer.app: <your-cdn-name> # This will be the name of your CDN
...
### Changing configuration for CDN deployment
...
All these configurations can be super useful when deploying a CDN.
...
```yaml
[package]
name = "<your-namespace>/<your-cdn-name>"
version = "0.1.0"
description = "<your-namespace>/<your-cdn-name> CDN on Wasmer Edge"
...
[fs]
public = "public"
config = "config" # 👈🏼 Add the config directory
...
Publish new version of package '<your-namespace>/<your-cdn-name>'? yes
Publishing package...
[1/2] ⬆️   Uploading...
[2/2] 📦  Publishing...
Successfully published package `<your-namespace>/<your-cdn-name>@0.1.0`
Waiting for package to become available.....
Package '<your-namespace>/<your-cdn-name>@0.1.0' published successfully!

Deploying app <your-namespace>-<your-cdn-name>...

 ✅ App <your-namespace>/<your-namespace>-<your-cdn-name> was successfully deployed!
...
<Callout type="info" emoji="ℹ️">
  And now you can view your CDN at the URL mentioned above. You can also view
  the admin dashboard of your CDN by visiting the URL mentioned above.
</Callout>
...
<Callout type="warning" emoji="🚧">
  The url of your CDN will be different from the one mentioned above.
</Callout>
...
In this tutorial, we learned how to create a CDN on Wasmer Edge using the `static-web-server` package.
