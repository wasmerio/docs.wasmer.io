...
The `debug` field is used to enable debug mode for the application. This in turn will show detailed error messages if a request fails, instead of a generic the instance failed. It is **optional** and can be any boolean.
