...
import { DeployIcon } from '@components/icons/ProductIcons'
...
<Cards>
<Card icon={<DeployIcon width={20} height={20} />} title="Deploy your first app" href="/edge/get-started" />
</Cards>
...
- **Stateless** HTTP workloads: <br/>
  You can use [proxy](/edge/learn/deployment-modes#proxy) to run web servers at the edge or [WCGI](/edge/learn/deployment-modes#wcgi) to run CGI at the edge.
...
- **Persistent volumes**: <br/>
  ...
  live somewhere.
  You can create [persistent volumes](/edge/learn/volumes) and mount them into
  your workloads.
- **Scheduled tasks / cronjobs**: <br/>
  Configure [scheduled invocation of your apps](/edge/configuration/jobs) at a
  given interval, and inspect logs and success status of the task runs.
