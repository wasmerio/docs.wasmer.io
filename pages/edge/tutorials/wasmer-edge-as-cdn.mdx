...
> App URL: https://wasmer-edge-as-cdn-sample.wasmer.app
> Versioned URL: https://2j6h5i7c00m4.id.wasmer.app
> Admin dashboard: https://wasmer.io/apps/wasmer-edge-as-cdn-sample

Waiting for new deployment to become available...
(You can safely stop waiting now with CTRL-C)
.
New version is now reachable at https://wasmer-edge-as-cdn-sample.wasmer.app
Deployment complete
```
...
<Callout type="warning" emoji="🚧">
  The url of your app will be different from the one mentioned above.
</Callout>
