...
exposed as mounted directories inside your apps. You can also access them
remotely by enabling S3-compatible access with per-volume credentials, or through
the file explorer in the dashboard.
