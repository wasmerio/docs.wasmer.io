...
```toml
[package]
name = "wasmer/python-flask-worker"
version = "0.1.1"
...
name: wasmer-python-flask-server-worker
...
```shell copy
$ wasmer deploy
Loaded app from: /Volumes/Work/Projects/wasmer-edge/python-flask/app.yaml
Deploying app wasmer-python-flask-server-worker...

 ✅ App dynamite-bud/wasmer-python-flask-server-worker was successfully deployed!

> App URL: https://wasmer-python-flask-server-worker.wasmer.app
> Versioned URL: https://2mzhyi8cqzxr.id.wasmer.app
> Admin dashboard: https://wasmer.io/apps/wasmer-python-flask-server-worker
...
<Card
  ...
  title="wasmerio/python-flask-server"
  href="https://github.com/wasmerio/python-flask-server"
/>
