...
- **Run stateless**, auto-scaled WebAssembly HTTP apps:<br/>
  You can use [proxy](/edge/learn/deployment-modes#proxy) or
  [WCGI](/edge/learn/deployment-modes#proxy) to run web servers in the edge.
...
To start using Wasmer Edge, check out the [Getting Started](/edge/getting-started) guide.
